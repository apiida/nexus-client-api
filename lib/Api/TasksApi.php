...
class TasksApi
{
    ...
    {
        list($response) = $this->getTasksWithHttpInfo($type);
        return $response;
    }
    ...
    {
        return $this->getTasksAsyncWithHttpInfo($type)
            ->then(
                function ($response) {
                    return $response[0];
                }
