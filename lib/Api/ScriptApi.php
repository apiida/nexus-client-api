...
class ScriptApi
{
    ...
    {
        $returnType = '';
        $request = $this->deleteRequest($name);
    ...
    {
        return $this->deleteAsyncWithHttpInfo($name)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        list($response) = $this->readWithHttpInfo($name);
        return $response;
    }
    ...
    {
        return $this->readAsyncWithHttpInfo($name)
            ->then(
                function ($response) {
                    return $response[0];
                }
